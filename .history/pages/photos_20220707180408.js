      ...
      <motion.main className="min-h-screen">
          <div className="absolute top-0 left-0 right-0 m-auto w-fit h-fit">
            ...
            <div className="w-[900px] h-fit flex justify-between xl:w-[350px] xl:flex-col xl:gap-8">
              <div>
                {photos.map((img, i) => (
                  <div key={i} className="mb-32">
                      ...
                      <div className="hidden invisiblew-[230px] h-[430px] flex-col justify-between mb-24 xl:flex xl:visible xl:w-full xl:text-center xl:h-[350px]">
                            <div>
              ...
              <div>
                {desc.map((desc, i) => (
                  <div key={i} className="w-[230px] h-[430px] flex flex-col justify-between mb-32 xl:hidden xl:invisible">
                    <div>
