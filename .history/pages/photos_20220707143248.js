...
const desc = [
    ...
    { id: 2, title: 'Ocean Blue', info: "Travel to Australia", date: "2nd of June, 2022", text: "This blog site is built with Next.js and designed by Figma. This website includes photos and posts related to my work.", footer: <}
]
      ...
      <motion.main className="min-h-screen">
          <div className="absolute top-0 bottom-0 left-0 right-0 m-auto w-fit h-fit">
            ...
            <div className="w-[900px] h-fit flex justify-between">
              ...
              <div>
                {desc.map((desc, i) => (
                  <div key={i} className="w-[230px] h-[430px] flex flex-col gap-8 mb-32">
                    <div>
