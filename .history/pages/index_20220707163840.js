          ...
          <div className="absolute top-0 bottom-0 left-0 right-0 m-auto w-fit h-fit">
            ...
            <div className="w-[900px] h-[430px] flex justify-between xl:w-[355px] xl:flex-col xl:h-fit xl:gap-8">
              ...
              <div className="w-[230px] h-full flex flex-col justify-between xl:w-full xl:text-center">
                <h1 className="text-[2.25rem] font-bold leading-10 xl:mb-8">Brima Freeman</h1>
                <div className="h-[215px] flex flex-col justify-between xl:h-fit xl:gap-8 xl:text-justify">
