      ...
      <motion.main className="min-h-screen">
          <div className="absolute top-0 left-0 right-0 m-auto w-fit h-fit">
            ...
            <div className="w-[900px] h-fit flex justify-between xl:w-[350px] xl:flex-col xl:h-fit xl:gap-8">
              ...
              <div>
                {desc.map((desc, i) => (
                  <div key={i} className="w-[230px] h-[430px] flex flex-col justify-between mb-32 xl:w-full xl:text-center">
                    <div>
                      <h1 className="text-[2rem] font-bold w-fit cursor-default xl:text-center">{desc.title}</h1>
