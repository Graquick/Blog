...
export default function Home() {
  return (
    <>
      <motion.main className="min-h-screen bg-blue-400">
        <div className="absolute bg-red-500 top-0 left-0 bottom-0 right-0 m-auto w-[900px] h-[430px] flex justify-between">
        <Header />
            <Image src={profile}
              alt="Photo of author"
              width={608}
