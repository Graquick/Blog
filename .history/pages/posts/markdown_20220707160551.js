...
const post = [
    {id: 1, title: "Markdown Examples", author: "Brima Freeman,", date: "Fri Mar 19 2022", tag: "web development", main: <div className="mt-12">
        ...
        <div className="flex flex-col gap-4 mb-16">
            ...
            <ul>
                Unordered
                <li className="relative before:content-[''] before:absolute before:-left-3 before:top-2 before:w-2 before:h-2 before:bg-slate-400 before:rounded-full">Lorem ipsum dolor sit amet</li>
                <li className="relative before:content-[''] before:absolute before:-left-3 before:top-2 before:w-2 before:h-2 before:bg-slate-400 before:rounded-full">Consectetur adipiscing elit</li>
                <li className="relative before:content-[''] before:absolute before:-left-3 before:top-2 before:w-2 before:h-2 before:bg-slate-400 before:rounded-full">Integer molestie lorem at massa</li>
            </ul>
            <ol>
                Ordered
