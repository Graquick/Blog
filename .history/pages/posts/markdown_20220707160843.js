    ...
    {id: 1, title: "Markdown Examples", author: "Brima Freeman,", date: "Fri Mar 19 2022", tag: "web development", main: <div className="mt-12">
        ...
        <div className="flex flex-col gap-4 mb-16">
            ...
            <ul className="flex flex-col gap-2">
                ...
                <li className="ml-8 relative before:content-[''] before:absolute before:-left-3 before:top-3 before:w-1 before:h-1 before:bg-slate-300 before:rounded-full">Lorem ipsum dolor sit amet</li>
                <li className="ml-8 relative before:content-[''] before:absolute before:-left-3 before:top-3 before:w-1 before:h-1 before:bg-slate-300 before:rounded-full">Consectetur adipiscing elit</li>
                <li className="ml-8 relative before:content-[''] before:absolute before:-left-3 before:top-3 before:w-1 before:h-1 before:bg-slate-300 before:rounded-full">Integer molestie lorem at massa</li>
            </ul>
            <ol>
