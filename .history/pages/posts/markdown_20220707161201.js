    ...
    {id: 1, title: "Markdown Examples", author: "Brima Freeman,", date: "Fri Mar 19 2022", tag: "web development", main: <div className="mt-12">
        ...
        <div className="flex flex-col gap-4 mb-16">
            ...
            <ol className="flex flex-col gap-4">
                ...
                <li className="ml-8 relative before:content-['1'] before:absolute before:-left-4 before:top-[.55rem]">Lorem ipsum dolor sit amet</li>
                <li className="ml-8 relative before:content-['2'] before:absolute before:-left-4 before:top-[.55rem]">Consectetur adipiscing elit</li>
                <li className="ml-8 relative before:content-['3'] before:absolute before:-left-4 before:top-[.55rem]">Integer molestie lorem at massa</li>
            </ol>
        </div>
    </div>}
]
