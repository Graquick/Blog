...
export default function Markdown() {
  return (
    <>
          <Head>
            <title>Markdown - Posts</title>
            <meta name="description" content="Generated by create next app" />
          </Head>

      <motion.main className="min-h-screen">
          <div className="absolute left-0 right-0 m-auto top-32 w-fit h-fit xl:flex xl:flex-col xl:top-12 xl:mb-12">
            ...
            <div className="absolute bottom-20 right-0 w-[230px] xl:w-[200px] xl:left-0 xl:right-0 xl:m-auto xl:bottom-0">
                <Footer />
            </div>
            </div>
        </div>
