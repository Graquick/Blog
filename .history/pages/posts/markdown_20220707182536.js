                ...
                {post.map((pos, i) => (
                    <div key={i}>
                        <div className="flex flex-col gap-8 xl:gap-4">
                            ...
                            <div className="flex justify-between w-[900px] font-medium text-neutral-500 xl:w-[355px] xl:h-[100px]">
                                ...
                                <Link href="/">
                                    <span className="underline cursor-pointer underline-offset-4 xl:absolute xl:left-0 xl:bg-red-600]">Back</span>
                                </Link>
                            </div>
                        </div>
                        {pos.main}
