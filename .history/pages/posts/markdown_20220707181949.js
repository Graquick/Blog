                    ...
                    <div key={i}>
                        <div className="flex flex-col gap-8">
                            ...
                            <div className="flex justify-between w-[900px] font-medium text-neutral-500 xl:w-[355px]">
                                ...
                                <span>{pos.date}</span>
                                <span className="ml-4 px-2 flex items-center justify bg-slate-300 rounded-full relative before:content-[''] before:absolute before:-left-3 before:top-2 before:w-2 before:h-2 before:bg-slate-400 before:rounded-full">{pos.tag}</span>
                                </div>
                                <Link href="/">
