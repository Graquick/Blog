                    ...
                    <div key={i}>
                        <div>
                            ...
                            <div className="flex gap-4 font-medium text-neutral-500">
                                ...
                                <span>{pos.date}</span>
                                <span className="ml-4 px-2 bg-slate-300 rounded-full relative before:content-[''] before:absolute before:left-0 before:w-4 before:h-4 before:bg-red-500">{pos.tag}</span>
                            </div>
                        </div>
                    </div>
                ))}
