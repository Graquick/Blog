    ...
    {id: 1, title: "Markdown Examples", author: "Brima Freeman,", date: "Fri Mar 19 2022", tag: "web development", main: <div className="mt-12">
        ...
        <div className="flex flex-col gap-4 mb-16">
            ...
            <ul className="flex flex-col gap-2">
                <span className="font-medium">Unordered</span>
            ...
            <ol>
                ...
                <li className="ml-8 relative before:content-['1'] before:absolute before:-left-4 before:top-[.55rem] before:w-1 before:h-1 before:bg-slate-300 before:rounded-full">Lorem ipsum dolor sit amet</li>
                <li className="ml-8 relative before:content-['2'] before:absolute before:-left-4 before:top-[.55rem] before:w-1 before:h-1 before:bg-slate-300 before:rounded-full">Consectetur adipiscing elit</li>
                <li className="ml-8 relative before:content-['3'] before:absolute before:-left-4 before:top-[.55rem] before:w-1 before:h-1 before:bg-slate-300 before:rounded-full">Integer molestie lorem at massa</li>
            </ol>
        </div>
    </div>}
]
