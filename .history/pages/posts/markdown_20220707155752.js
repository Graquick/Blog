...
const post = [
    {id: 1, title: "Markdown Examples", author: "Brima Freeman,", date: "Fri Mar 19 2022", tag: "web development", main: <div className="">
        <div>
            <h2>h2 Heading</h2>
            <h3>h3 Heading</h3>
            <h4>h4 Heading</h4>
  ...
  return (
    <>
      ...
      <motion.main className="min-h-screen">
          <div className="absolute left28 right-0 m-auto top-32 w-fit h-fit">
