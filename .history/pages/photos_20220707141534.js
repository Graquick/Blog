...
const photos = [
    { id: 1, src: photo1, desc: "This blog site is built with Next.js and designed by Figma. This website includes photos and posts related to my work.", desc2: "This blog site is built with Next.js and designed by Figma. This website includes photos and posts related to my work."  },
      ...
      <motion.main className="min-h-screen">
          <div className="absolute top-0 left-0 bottom-0 right-0 m-auto w-fit h-fit">
            ...
            <div className="w-[900px] h-[430px] flex justify-between">
              ...
              <div className="w-[230px] bg-green-400 h-full flex flex-col justify-between">
                {desc.map((desc, i) => (
                  div
                ))}
              </div>
