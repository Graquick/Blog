...
const desc = [
    ...
    { id: 3, title: 'Ocean Blue', info: "Travel to Australia", date: "2nd of June, 2022", text: "This blog site is built with Next.js and designed by Figma. This website includes photos and posts related to my work.", footer: <Footer />}
]
  ...
  return (
    <>
      <motion.main className="min-h-screen">
          <div className="sticky top-0 left-0 right-0 m-auto w-fit h-fit">
            <Header />
