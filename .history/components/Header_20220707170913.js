            ...
            <nav className="h-fit">
                ...
                <ul className="hidden invisible flex-col gap-2 xl:flex xl:visible">
                    {linksMobile.map((linksM, i) => (
                        <div key={i} className={router.pathname === linksM.href ? "underline-offset-4 underline visible" : ""}>
                            <li className={router.pathname === linksM.href ? "underline-offset-4 underline visible" : ""} >
