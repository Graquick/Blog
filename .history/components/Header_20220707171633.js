                ...
                <ul className="hidden invisible flex-col gap-2 xl:flex xl:visible">
                    {router.pathname === '/' &&
                        <li>
                            ...
                            <Link href='/photos'>
                                <div className="flex gap-1 items-center cursor-pointer underline-offset-4 underline" onClick={() => setOpen(!open)}>   
                                    Photos{router.pathname === '/' && <motion.div variants={iconAnim} animate={open ? "opened" : "closed"}><Icon icon="dashicons:arrow-down-alt2" /></motion.div>}
                                </div>
                            </Link>
                            <Link href='/posts'>
                                <div className="flex gap-1 items-center cursor-pointer underline-offset-4 underline" onClick={() => setOpen(!open)}>   
                                    Posts{router.pathname === '/' && <motion.div variants={iconAnim} animate={open ? "opened" : "closed"}><Icon icon="dashicons:arrow-down-alt2" /></motion.div>}
                                </div>
                            </Link>
