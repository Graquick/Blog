...
function Header() {
  ...
  return (
    <>
        <main className="absolute bg-red-500 top-0 left-0 bottom-0 right-0 m-auto right-0 m-auto z-20 p-8 bg-white w-[964px] mb-8 h-[8rem] flex justify-between items-center">
            <div >
                <Logo />
            </div>
